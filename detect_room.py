...
MODEL = YOLO("weights/lsb_room_v2.pt")
# MODEL = YOLO(
#     "runs/detect/detect_room_v10_yolov11_m_fine_tune_unfreeze_all/weights/best.pt"
# )

input = "pdf_files/LSB_room1.pdf"
output = "pdf_files/LSB_room1_detect.pdf"
...
def run(pdf_path, out_path, use_overlap=False):
    ...
    for i, page in enumerate(doc):
        ...
        cv2.imwrite("detect_images/lsb/lsb_room" + str(i) + ".png", result_img)
